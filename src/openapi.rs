...
#[openapi(
    paths(
        ...
        crate::features::open_platform::keys::get_api_key_rate_limit,
        ...
        crate::features::leaderboard::handler::get_admin_leaderboard_users,
        crate::features::leaderboard::handler::post_resolve,
        crate::features::leaderboard::handler::get_admin_user_status,
        crate::features::leaderboard::handler::post_admin_user_status,
